...
import { setupRouter } from '@nav/shared/util/testing';
...
describe('Meter Group Page', () => {
  beforeEach(() => {
    ...
    fetchMock.mockResponse(async (req) => {
      if (req.url.match(/v1\/load\/meter_group\/\d+/)) {
        return JSON.stringify(meterGroup);
  ...
  describe('Header',  () => {
    test('Meter group name is rendered', async () => {
      ...
      const expectedFileName = meterGroup.originfile.filename.replace(/origin_files\//, '');
...
const meters = {
  ...
  "results": [
    ...
    {
      "id": "19ac74fd-9d88-4117-9584-08db11c957e9",
      "meter_type": "customermeter",
      "meter_groups": [
        "41a14706-77a8-467e-8f3a-ac4c250ae66a",
        "631ee02f-a49f-4c72-806c-ae811488cc83"
