...
const useFirstColumnStyles = makeStylesHook(theme => ({
  firstColumn: {
    ...
    <>
      ...
      <Card raised>
        <Typography useDiv variant="body1">
          ...
          multiple DER customer program scenarios. By identifying the customers that would provide the
          highest grid and environmental benefits if enrolled in each simulated program scenario,
          NavigaDER enables CCAs to make informed decisions about which DER technologies to promote to
          which specific customers so as to optimize GHG and financial benefits.
        </Typography>
        ...
        <Typography className={classes.boldParagraph} emphasis="bold" useDiv variant="body1">
          ...
          additional feature development. The software will be continually updated through Q3 2020 to
          improve functionality and the user experience.
        </Typography>
      </Card>

      <PrefetchedTable data={[]} raised>
        {() =>
          <>
            <Table.Head>
              <Table.Row className={classes.goldHeader}>
                <Table.Cell colSpan={4}>
                  <Centered>BUILT FEATURES</Centered>
                </Table.Cell>
              </Table.Row>
              <Table.Row className={classes.greyHeader}>
            ...
            <Table.Body>
              ...
              <Table.Row>
                ...
                <Table.Cell>
                  ...
                  customers have the highest potential for battery assisted NEM payout reduction by
                  analyzing customer load profiles. The software will target the NEM customers that
                  have sufficient exports to charge batteries which can be subsequently discharged
                  against the customer's load during the target peak hours of the day (4-9pm). The
                  software will simulate battery energy storage systems to charge from solar PV
                  exports (reducing the CCA's NEM payouts), and discharge during the peak hours,
                  thereby helping reduce the customer's consumption of electricity from the grid
                  during the time when procurement and electricity demand for the CCA is highest.
                </Table.Cell>
                <Table.Cell>
                  <Complete />
                </Table.Cell>
              ...
              <Table.Row>
                ...
                <Table.Cell>
                  ...
                  peaks occur. The software then targets customers with load during these hours, and
                  creates a battery cycling strategy that will target discharging during these peak
                  hours. In the simulation the batteries are applied to the targeted customers,
                  reducing the customer load at the time of the system peaks, ultimately reducing
                  the system and local RA requirements of the CCA.
                </Table.Cell>
                <Table.Cell>
                  <Complete />
                </Table.Cell>
              ...
              <Table.Row>
                ...
                <Table.Cell>
                  ...
                  impacts. The software applies the appropriate GHG values to the electricity bought
                  at every time of day before and after implementing the simulated DER program, and
                  then compares how GHG emissions have been impacted by the simulated DER program
                  implementation. The Clean Net Short (CNS) methodology is used in the calculations,
                  as is recommended by the California Public Utilities Commission.  The CNS method
                  utilizes standard reference tables with multipliers for every hour of a month to
                  account for the grid GHG content. The reference tables provide an estimate of the
                  grid GHG content for any location in the state of California, at any given hour of
                  the day.
                </Table.Cell>
                <Table.Cell>
                  <Complete />
            ...
            <Table.Head>
              <Table.Row className={classes.goldHeader}>
                <Table.Cell colSpan={4}>
                  <Centered>DEVELOPMENT OF ADDITIONAL FEATURES</Centered>
                </Table.Cell>
              </Table.Row>
              <Table.Row className={classes.greyHeader}>
                <Table.Cell>Category</Table.Cell>
                ...
                <Table.Cell>Description</Table.Cell>
                <Table.Cell>Anticipated Release</Table.Cell>
              </Table.Row>
            </Table.Head>
            ...
            <Table.Body>
              <Table.Row>
                ...
                <Table.Cell>
                  Multiple EVSE strategies will be available to the user for selection when creating
                  a DER program scenarios
                </Table.Cell>
                <Table.Cell>Sep 1, 2020</Table.Cell>
              </Table.Row>
              <Table.Row>
