...
import { Grid, Link, Menu, List, PrefetchedTable, Table } from 'navigader/components';
import { CAISORate } from 'navigader/types';
import { slices } from 'navigader/store';
import { formatters, hooks } from 'navigader/util';
import { useCAISORates } from 'navigader/util/hooks';
...
export const CAISORateList = () => {
  ...
  const caisoRates = useCAISORates({ data_types: ['default'] });
  ...
  async function deleteCAISORate() {
    if (caisoRateToDelete) {
      ...
      if (response.ok) {
        ...
        setCaisoRateToDelete(undefined);
      }
    }
  }
};
