...
export const MonthSelectorExclusive: React.FC<MonthSelectorExclusiveProps> = (props) => {
  ...
  return (
    <Toggle.Group exclusive onChange={onChange} size="small" value={selected}>
      <Toggle.Button value={1} aria-label="January">
        Jan
      </Toggle.Button>
      <Toggle.Button value={2} aria-label="February">
        Feb
      </Toggle.Button>
      <Toggle.Button value={3} aria-label="March">
        Mar
      </Toggle.Button>
      <Toggle.Button value={4} aria-label="April">
        Apr
      </Toggle.Button>
      <Toggle.Button value={5} aria-label="May">
        May
      </Toggle.Button>
      <Toggle.Button value={6} aria-label="June">
        Jun
      </Toggle.Button>
      <Toggle.Button value={7} aria-label="July">
        Jul
      </Toggle.Button>
      <Toggle.Button value={8} aria-label="August">
        Aug
      </Toggle.Button>
      <Toggle.Button value={9} aria-label="September">
        Sep
      </Toggle.Button>
      <Toggle.Button value={10} aria-label="October">
        Oct
      </Toggle.Button>
      <Toggle.Button value={11} aria-label="November">
        Nov
      </Toggle.Button>
      <Toggle.Button value={12} aria-label="December">
        Dec
      </Toggle.Button>
    </Toggle.Group>
  );
...
export const MonthSelector: React.FC<MonthSelectorProps> = (props) => {
  const { onChange, selected } = props;
  return (
    <Toggle.Group onChange={toggleMonth} size="small" value={selected}>
      <Toggle.Button value={1} aria-label="January">
        Jan
      </Toggle.Button>
      <Toggle.Button value={2} aria-label="February">
