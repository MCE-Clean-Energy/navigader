...
describe('`IntervalDataWrapper` class', () => {
  /** ============================ Test fixtures =========================== */
  const kwInterval = IntervalDataWrapper.create({
    times: ['June 2, 2020 18:00:00', 'June 2, 2020 18:15:00', 'June 2, 2020 18:30:00'],
    kw: [1, 2, 3],
    name: 'KW interval'
  }, 'times', 'kw');
  
  const sparseInterval = new IntervalDataWrapper([
  ...
  const juneInterval = new IntervalDataWrapper([
  ...
  describe('`filter` method', () => {
    ...
    it('handles filtering by `month`', () => {
      ...
      const monthInterval = new IntervalDataWrapper([
        { timestamp: new Date('June 2, 2020 18:00:00'), value: 1 },
  ...
  describe('`subtract` method', () => {
    ...
    it('drops intervals that do not align', () => {
      const interval1 = new IntervalDataWrapper([
      ...
      const interval2 = new IntervalDataWrapper([
      ...
      // Dates don't align
      const june1Interval = new IntervalDataWrapper([
      ...
      const june2Interval = new IntervalDataWrapper([
        { timestamp: new Date('June 2, 2020 18:00:00'), value: 4 },
        { timestamp: new Date('June 2, 2020 18:15:00'), value: 3 },
        { timestamp: new Date('June 2, 2020 18:30:00'), value: 2 },
        { timestamp: new Date('June 2, 2020 18:45:00'), value: 1 }
  ...
  describe('`divide` method', () => {
    it('divides the intervals value respectively', () => {
      const largeInterval = new IntervalDataWrapper([
  ...
  describe('`create` method', () => {
    it('creates an `IntervalDataWrapper` from the provided object', () => {
      const kwInterval = IntervalDataWrapper.create({
        times: ['June 2, 2020 18:00:00', 'June 2, 2020 18:15:00', 'June 2, 2020 18:30:00'],
        kw: [1, 2, 3],
        name: 'KW interval'
